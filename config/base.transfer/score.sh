...
python3 translate.py -ckpt checkpoints/checkpoint_best_ppl.pth -text /data/NMT/data/defr-en/test.de-en.de -ref_text /data/NMT/data/defr-en/test.de-en.en --max_batch_size 0 --tokens_per_batch 2000 -max_len 200 > total.out
