...
python3 translate.py -ckpt checkpoints/checkpoint_12.pth -text /data/NMT/data/de-en/news_crawl/test.de-en.de -ref_text /data/NMT/data/de-en/news_crawl/test.de-en.en --max_batch_size 0 --tokens_per_batch 2000 -max_len 200 --src_lan de --tgt_lan en --greedy > total.out
