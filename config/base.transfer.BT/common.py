...
class Config:
    ...
    SRC_RAW_TRAIN_PATH = DATA_PATH + "/train.fr-en.en"
    TGT_RAW_TRAIN_PATH = DATA_PATH + "/train.fr-en.fr"
    SRC_RAW_VALID_PATH = DATA_PATH + "/valid.fr-en.en"
    TGT_RAW_VALID_PATH = DATA_PATH + "/valid.fr-en.fr"
