...
class Config:
    ...
    # data paths
    DATA_PATH="../../data/pivot_BT_data/"
    SRC_RAW_TRAIN_PATH = DATA_PATH + "train.fr-de.de"
    TGT_RAW_TRAIN_PATH = DATA_PATH + "train.fr-de.fr"
    SRC_RAW_VALID_PATH = DATA_PATH + "valid.fr-de.de"
    TGT_RAW_VALID_PATH = DATA_PATH + "valid.fr-de.fr"
    if share_all_embeddings:
        ...
        TGT_VOCAB_PATH = DATA_PATH + "vocab.fr"
