...
INIT_SRC=../base.wmt17.active_base.budget_by_n_sent/result/random/active_data/labeled_1.$SRC
INIT_TGT=../base.wmt17.active_base.budget_by_n_sent/result/random/active_data/labeled_1.$TGT
INIT_UNLABELED=../base.wmt17.active_base.budget_by_n_sent/result/random/active_data/unlabeled_1
INIT_ORACLE=../base.wmt17.active_base.budget_by_n_sent/result/random/active_data/oracle_1
	...
	do	
		...
		if [ $i -ne $N_ROUNDS ]; then
			...
			python3 active.py modify -U $U$((i+1)) \
				...
				--oracle $ORACLE$((i+1)) -sb $SENt_BUDGET \
