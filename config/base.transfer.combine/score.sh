function test () {
	...
	python3 translate.py -ckpt result/checkpoints/$i/checkpoint_best_ppl.pth -text ~/test_2016/transfer/test.de -ref_text ~/test_2016/transfer/test.en --max_batch_size 0 --tokens_per_batch 2000 -max_len 200 > total.out
