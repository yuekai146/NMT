...
class Config:
    ...
    SRC_RAW_TRAIN_PATH = DATA_PATH + "train.fr-de.fr"
    TGT_RAW_TRAIN_PATH = DATA_PATH + "train.fr-de.de"
    SRC_RAW_VALID_PATH = DATA_PATH + "valid.fr-de.fr"
    TGT_RAW_VALID_PATH = DATA_PATH + "valid.fr-de.de"
