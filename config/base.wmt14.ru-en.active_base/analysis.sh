function run () {
	...
	aws --endpoint-url=http://oss.hh-b.brainpp.cn s3 cp s3://zhaoyuekai/active_NMT/config/base.wmt17.active_base/$method/active_data/labeled_$i.de data_tmp/
	...
	aws --endpoint-url=http://oss.hh-b.brainpp.cn s3 cp s3://zhaoyuekai/active_NMT/config/base.wmt17.active_base/$method/active_data/labeled_$i.en data_tmp/
